...
while (notAnswered) {
    userChoise = prompt("Виберіть тему 1-темна, 2-світла")
    ...
    switch (userChoise) {
        ...
        case '2':
            ...
            break;
        default:
            alert('Ви ввели неправельний варіант')    
    }
}

console.log('1-OK!')

let container = "<div class='" + selectedThemes + "'>"
let header = "<header><h1>Пірати карибського моря</h1></header><hr>"
let main = "<main><div><ul>"

let li = ''
for (let i = 0; i < movies.length; i++) {
    li = li + "<li><img src='images/" + movies[i][1] + "' alt=''><p>" + movies[i][0] + "</p></li>"
}
